...
osMailQId myQueue02Handle;
osMutexId gConfigMutexHandle;
/* USER CODE BEGIN PV */
...
int main(void)
{
  ...
  /* Create the mutex(es) */
  /* definition and creation of gConfigMutex */
  ...
  mySem01Handle = xSemaphoreCreateBinary();
...
static void MX_GPIO_Init(void) {
  ...
  /*Configure GPIO pins : PB10 PB12 PB13 PB14 PB15 (TFT Control + Buttons) */
  ...
  /*Configure GPIO pins : PB12 PB13 PB14 PB15 (Buttons) */
  GPIO_InitStruct.Pin = GPIO_PIN_12 | GPIO_PIN_13 | GPIO_PIN_14 | GPIO_PIN_15;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pin : PA8 (Button) */
